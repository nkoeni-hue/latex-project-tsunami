...
\begin{itemize}
    \item Random debris fields produced more scattered and generally smaller peaks compared to regular arrangements. The overall variability of the data increased (Fig.~\ref{fig:random_peaks_first}). 
    ...
    \item The influence of surface area density was critical in shaping impact likelihood and synchronization:
    \begin{itemize}
...
\section{Results: Damming Forces}
\begin{itemize}
    ...
    \item Longitudinal vs.\ transverse: while the overall magnitudes were comparable, transverse cases produced higher damming loads once debris counts exceeded eight. This supports the broader trend that longitudinal arrangements dominate impact peaks, while transverse arrangements dominate damming.
