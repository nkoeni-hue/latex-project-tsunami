...
The results reported in Table \ref{tab:mode_summary} show that the identified modal frequencies of the structure in water were lower than those identified for the in-air tests.  This change is consistent with increased resistance provided by the surrounding water.  Note that the percentage frequency difference was larger for the higher modes than the lower modes, consisting of decreases of 6 percent, 26 percent and 2 percent for modes 1, 2 and 3. 

Table \ref{tab:mode_summary} also reports the damping ratios identified for the in-air and in-water tests.  The damping ratio tended to decrease with increasing mode order, and the ratio was consistently larger for the in-water tests than the in-air tests.  the damping ratios increased substantially when the structure was tested in water. The percentage increase in damping was approximately 160 percent, 370 percent, and 80 percent for modes 1, 2, and 3, respectively. The second mode showed the greatest sensitivity to the surrounding fluid.
...
Figure~\ref{fig:random_peaks_first} show the impact reaction forces from the first impact,  separated by packing ratio. Boxplot whiskers indicate the minimum and maximum values, the boxes show the interquartile range (IQR), and the solid line within each box marks the median value.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{First_Peak_RANDOM_Single_ONLY_Shaded.png}
...
\begin{figure}[htbp]
    ...
    \caption{Impact probabilities across random trials for various debris field widths. Marker area reflects the number of data points for each incident.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{Damming_RANDOM_Single_ONLY_Shaded.png}
    \caption{Damming reaction forces in random debris fields versus debris count. Shading indicates Packing Ratio.}
