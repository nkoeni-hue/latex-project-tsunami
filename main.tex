...
The model predictions are plotted alongside the measured data, with error bars representing the standard error of the mean (SEM) for each condition. These error bars indicate the variability of the median first impact estimate across trials, providing a measure of uncertainty in the observed values. The regression lines illustrate the hierarchical model predictions, accounting for orientation, type, and Packing Ratio adjustments.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/PredVSMeas.png}
    \caption{Predicted versus measured $F(N)/F(1)$ using the model. The diagonal line represents perfect agreement between predicted and measured values.}
...
\begin{figure}[h]
    ...
    \caption{Regression of regular L- and T-orientation trials. Markers show measured median first impacts with error bars (standard error of the median), and lines show the model fit.}
...
\begin{figure}[h]
    ...
    \caption{Regression for Single-type trials. Markers show measured median first impacts with error bars. Solid lines indicate baseline fits, dashed lines Packing Ratio-adjusted fits for low-Packing Ratio trials.}
...
\begin{figure}[h]
    ...
    \caption{Regression for Multi-type trials. Markers show measured median first impacts with error bars. Solid lines indicate baseline fits, dashed lines Packing Ratio-adjusted fits for low-Packing Ratio trials.}
