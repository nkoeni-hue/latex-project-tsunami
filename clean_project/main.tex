...
\begin{figure}[htbp]
    ...
    \caption{Comparison of debris size at the first peak for regular configurations.}
    \label{fig:firstpeak_regular}
\end{figure}

\begin{figure}[htbp]
    \centering
    % Quadratic Fit across All First-Peak Values
    \includegraphics[width=0.7\textwidth]{QuadraticFit_FirstPeak_AllData.png}
    \caption{Quadratic fit through all normalized first-peak values. Scatter points represent individual trial measurements, and the black dashed line shows the quadratic trend.}
