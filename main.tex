...
\begin{figure}[h]
    ...
    \caption{Predicted versus measured F(N)/F(1) using the hierarchical factor model. The diagonal line represents perfect agreement.}
...
\begin{figure}[h]
    ...
    \caption{Regression analysis of regular orientations L and T. Shaded regions indicate confidence intervals and the lines show the hierarchical factor model fit.}
...
\begin{figure}[h]
    ...
    \caption{Regression analysis for Multi-type trials. Confidence intervals are shown for high- and low-density points. Solid lines indicate baseline fits, dashed lines density-adjusted fits.}
...
\begin{figure}[h]
    ...
    \caption{Regression analysis for Single-type trials. Confidence intervals for high- and low-density points are shown. Solid lines indicate baseline fits, dashed lines density-adjusted fits.}
