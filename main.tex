...
Figure~\ref{fig:random_peaks_first} and Figure~\ref{fig:random_peaks_adjusted} show the impact reaction forces from the first impacts,  separated by packing ratio. Boxplot whiskers indicate the minimum and maximum values, the boxes show the interquartile range (IQR), and the solid line within each box marks the median value.
...
In the first impact peaks, single-sized debris fields consistently yielded higher forces than multi-sized fields, and increasing packing ratio raised the magnitude of impact (Figure~\ref{fig:random_peaks_first}). Later impact peaks, occurring after initial contact and partial submergence, showed only a slight increase with debris count 
...
\begin{figure}[htbp]
    ...
    \caption{First impact reaction forces in random debris fields versus debris count, adjusted to account for field width.}
...
\begin{figure}[htbp]
    ...
    \caption{Damming reaction forces in random debris fields versus debris count, adjusted to account for field width.}
