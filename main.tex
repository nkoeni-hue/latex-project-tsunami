...
\begin{equation}
F_\mathrm{pred}(N, \text{Type}, \text{Packing Ratio}) 
...
The model predictions are plotted alongside the measured medians, with error bars representing the standard error of the mean (SEM) for each condition. These error bars indicate the variability of the median first impact estimate across trials, providing a measure of uncertainty in the observed values. The regression lines illustrate the model predictions, accounting for orientation, type, and Packing Ratio adjustments.
