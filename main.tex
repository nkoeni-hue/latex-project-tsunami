...
Note also that the modal properties for the In-Air varied less than those identified for the in-water tests. This increased variability is consistent with previous observations that fluid–structure interactions introduce greater uncertainty and variability into tests compared to tests conducted in In-Air conditions.
...
This section describes the observed trends in observed the first impact, later impact and damming reactions for the regular configurations. The regular configurations are described in Figure \ref{fig:configurations} and Table \ref{tab:debris-configurations-compact}, and the values of the maximum reactions are reported in the Annex. 
...
\begin{figure}[htbp]
    ...
    \caption{First impact reaction forces in random debris fields versus Effective Debris Count. Shading indicates Packing Ratio.}
...
\begin{figure}[htbp]
    ...
    \caption{First impact reaction forces in random debris fields versus Effective Debris Count, adjusted for Debris Field Width. Shading indicates Packing Ratio.}
...
\begin{figure}[htbp]
    ...
    \caption{Damming reaction forces in random debris fields versus Debris Count, adjusted for Debris Field Width. Shading indicates Packing Ratio.}
