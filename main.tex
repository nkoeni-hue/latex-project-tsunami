...
\begin{figure}[htbp]
    ...
    \caption{Comparison of reaction forces for various debris sizes at first impact for regular configurations. The 1L median reaction serves as the baseline for normalization.}
